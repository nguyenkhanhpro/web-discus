    ...
    <header>
        <div class='header'>
            ...
            <form action="find_question.php" method = "GET">
                ...
                <input type="text" name='question' id='question' placeholder="Tìm kiếm câu hỏi">
                ...
                <?php
                    ...
                    {
                        $question_find = $_GET['question'];
                        $sql_select_question_find = "SELECT * FROM question like '%$question_find%'";
                        $result = $conn->query($sql_select_question_find);
                    }
                ?>
            </form>
            ...
            <div>
                <?php
                    ...
                    $sql = "SELECT question.posting_time,users.user_name,users.avatar,question.question_id,question.question
                                    ...
                                    WHERE question.question = '$question_find'
                            ...
                            while ($row = $result_name-> fetch_assoc())
                            {
                                 ...
                                 if(isset($_POST['delete']))
                                    {
                                        ...
                                        if ($result_dele_img == TRUE)
                                        {
                                            ...
                                            if($result_dele_question_comment == TRUE)
                                            {
                                ...
                                {
                                    $question_id_select = $_POST['question_id'];
